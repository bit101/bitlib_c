...
bl_point *bl_random_point_in_triangle(bl_point *p0, bl_point *p1,
                                      bl_point *p2) {
  ...
  double c = s * sqrt(t);
  return bl_make_point(a * p0->x + b * p1->x + c * p2->x,
...
double bl_point_angle(bl_point *p) { return atan2(p->y, p->x); }
...
double bl_angle_between(bl_point *p0, bl_point *p1, bl_point *p2,
                        bl_point *p3) {
...
bl_point *bl_bezier_point(bl_point *p0, bl_point *p1, bl_point *p2,
  ...
  double m3 = t * t * t;
  return bl_make_point(m0 * p0->x + m1 * p1->x + m2 * p2->x + m3 * p3->x,
...
bl_point *bl_quadratic_point(bl_point *p0, bl_point *p1, bl_point *p2,
  ...
  double m2 = t * t;
  return bl_make_point(m0 * p0->x + m1 * p1->x + m2 * p2->x,
...
bl_point *bl_tangent_point_to_circle(bl_point *p, double x, double y, double r,
  ...
  return bl_make_point(x + cos(totalAngle) * r, y + sin(totalAngle) * r);
}
